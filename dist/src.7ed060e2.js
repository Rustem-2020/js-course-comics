...
},{}],"../src/constants/api.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.URL_COMICS = exports.URL_CHARACTERS = exports.NO_IMAGE = exports.IMG_SIZE = exports.API_URL = exports.API_KEY = void 0;
var API_URL = 'https://gateway.marvel.com/v1/public/';
exports.API_URL = API_URL;
var URL_COMICS = 'comics';
...
var IMG_SIZE = 'standard_xlarge';
exports.IMG_SIZE = IMG_SIZE;
var NO_IMAGE = 'image_not_available';
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"../src/utils/getDataApi.js":[function(require,module,exports) {
"use strict";
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                return _context.abrupt("return", responce.data.data.results);
...
},{"axios":"../node_modules/axios/index.js","../constants/api.js":"../src/constants/api.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
module.exports = {
  "comics__container": "_comics__container_3353a",
  "comics__item": "_comics__item_3353a",
  "comics__name": "_comics__name_3353a",
  "comics__img": "_comics__img_3353a"
};
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../src/constants/root.js":[function(require,module,exports) {
"use strict";
...
module.hot.accept(reloadCSS);
module.exports = {
  "wrapper": "_wrapper_a3907",
  "characters__container": "_characters__container_a3907",
  "characters__item": "_characters__item_a3907",
  "characters__img": "_characters__img_a3907",
  "characters__name": "_characters__name_a3907",
  "characters__close": "_characters__close_a3907"
};
...
var _getDataApi = require("../../utils/getDataApi.js");
  ...
  _createClass(Characters, [{
    ...
    value: function renderContent(data) {
      ...
      data.forEach(function (_ref) {
        ...
        var imgSrc = path + '.' + extension;
        htmlContent += "\n                <li class=\"".concat(_Characters.default.characters__item, "\">\n                    <h3  class=\"").concat(_Characters.default.characters__name, "\">").concat(name, "</h3>\n                    <img  class=\"").concat(_Characters.default.characters__img, "\" src=\"").concat(imgSrc, "\"/>\n                   \n                </li>\n            ");
      });
      var htmlWrapper = "\n        <div class=\"".concat(_Characters.default.wrapper, "\">\n                <ul class=\"").concat(_Characters.default.characters__container, "\">").concat(htmlContent, "</ul>\n                <button \n                class=\"").concat(_Characters.default.characters__close, "\"\n                onclick=\"modal.innerHTML=''\">Close</button>\n        </div>\n            ");
      _root.ROOT_MODAL.innerHTML = htmlWrapper;
    }
  }, {
    key: "renderNotif",
    value: function renderNotif() {
      var htmlCont = "\n        <div style=\"position:fixed;top:0;border:3px solid red;background:white;\">\n            <h2>No content!</h2>\n            <button onclick=\"modal.innerHTML=''\">Close</button>\n        </div>\n        ";
      _root.ROOT_MODAL.innerHTML = htmlCont;
    }
  }, {
    key: "render",
    value: function () {
...
},{"./Characters.css":"../src/components/Characters/Characters.css","../../utils/getDataApi.js":"../src/utils/getDataApi.js","../../constants/root":"../src/constants/root.js"}],"../src/components/Characters/index.js":[function(require,module,exports) {
"use strict";
...
module.hot.accept(reloadCSS);
module.exports = {
  "error__container": "_error__container_e476d",
  "error__alert": "_error__alert_e476d"
};
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./Error":"../src/components/Error/Error.js"}],"../src/components/Comics/Comics.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Comics, [{
    ...
    value: function renderComics(data) {
      ...
      data.forEach(function (_ref) {
        ...
        if (path.lastIndexOf(_api.NO_IMAGE) === -1) {
          var uri = _api.API_URL + _api.URL_COMICS + '/' + id + '/' + _api.URL_CHARACTERS;
          var imgSrc = path + '/' + _api.IMG_SIZE + '.' + extension;
          htmlContent += "\n                    <li class=\"comics__item ".concat(_Comics.default.comics__item, "\" data-uri=\"").concat(uri, "\">\n                    <span class=\"").concat(_Comics.default.comics__name, "\">").concat(title, "</span>\n                    <img class=\"").concat(_Comics.default.comics__img, "\" src='").concat(imgSrc, "'/>\n                    </li>\n                ");
        }
      });
      var htmlWrapper = "\n                <ul class=\"".concat(_Comics.default.comics__container, "\">").concat(htmlContent, "</ul>\n            ");
      _root.ROOT_INDEX.innerHTML = htmlWrapper;
    }
  }, {
    key: "render",
...
exports.default = _default;
},{"../../constants/api.js":"../src/constants/api.js","../../utils/getDataApi.js":"../src/utils/getDataApi.js","./Comics.css":"../src/components/Comics/Comics.css","../../constants/root":"../src/constants/root.js","../Characters":"../src/components/Characters/index.js","../Error":"../src/components/Error/index.js"}],"../src/components/Comics/index.js":[function(require,module,exports) {
"use strict";
